...
#include "opencv_cam1/subscriber_node.hpp"
...
int main(int argc, char **argv)
{
  ...
  auto camera_node = std::make_shared<opencv_cam1::OpencvCamNode1>(options);
  executor.add_node(camera_node);

  // Create and add subscriber node
  auto subscriber_node = std::make_shared<opencv_cam1::ImageSubscriberNode>(options);
